				...
				<div
						...
						<form action="processform" method="post"
							...
							<div class="custom-input-group">
								<span> <i class="fa-solid fa-user fs-3 me-4"
									...
									class="custom-input" placeholder="Name" name="name"></span>
							</div>
							...
							<div class="custom-input-group">
								<span> <i class="fa-solid fa-message fs-3 me-4"
									...
									class="custom-input" placeholder="Email" name="email"></span>
							</div>
							<div class="custom-hr-tag mb-4"></div>
							...
							<div class="custom-input-group">
								<span> <i class="fa-solid fa-user fs-3 me-4"
									...
									class="custom-input" placeholder="Phone number" name="name"></span>
							</div>
							<div class="custom-hr-tag mb-4"></div>
					...
					<div class="input-group text-white mt-4">
						<span class="ms-5">I'm already member ! <a
							...
							href="/html/signin.html">signin</a></span>
					</div>
				</div>
			</div>
			</div>
